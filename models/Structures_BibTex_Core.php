...
class Structures_BibTex_Core
{
     ...
     * @return void
     */
    function Structures_BibTex_Core($options = array())
    {
    ...
    function bibTex()
    {
        ...
        {
            //Intro
            $bibtex .= '@'.strtolower($entry['entryType']).' { '.$entry['cite'].",<br/>";
            //Author
            ...
            foreach ($entry as $key=>$val)
            {
                ...
                if (!in_array($key, array('cite','entryType','author')) && $val != '')
                {
                    $bibtex .= "&nbsp;&nbsp;&nbsp;".$key.' = {'.$val."},<br/>";
                }
            }
